# HTML-Form-project
This is the second project from the Microverse HTML/CSS Main curriculum. The project is about rebuilding Mint.com page for signing up new users. It is under the Odin project curriculum that serves to practice creating and styling forms. 
# Built with
